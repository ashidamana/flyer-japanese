...
<html>
    <head>
        ...
        <meta name="description" content="小飞鸟日语学习监督部,由爱菜家、希望之神小飞鸟于2017年09月07日成立，以互相学习，互相监督，共同进步为目标。采用极具实践性、持续性、高效性的小飞鸟&啊叶联合日语学习模式，于2017年09月11日起正式实施。">
        <link rel="shortcut icon" href="https://blog.mana.love/img/favicon.png">
        <link rel="stylesheet" href="./lib/layui/css/layui.css">
        <link rel="stylesheet" href="./res/css/global.css">
        <link rel="stylesheet" href="./res/css/clock.min.css">
    </head>
    <body>
        <!--头部-->
                ...
                <div class="layui-col-md4">
                    ...
                    <div class="layui-row layui-hide-xs">
                        <div class="layui-col-md12">
                            <div class="fly-panel">
                                <h3 class="fly-panel-title">惜时胜金</h3>
                                <div class="fly-panel-main" style="padding: 0 15px 0 0;margin-bottom: -80px;">
                                    ...
                                    <div class="layui-tab-item layui-show">
                                        <form action="" method="post">
                                            ...
                                            <div class="layui-form-item">
                                                <div class="layui-inline">
                                                    ...
                                                    <div class="layui-input-inline">
                                                        <input type="text" name="50_tone" placeholder="请输入五十音" autocomplete="off" class="layui-input" lay-verify="required">
                                                    </div>
                                            ...
                                            <div class="layui-form-item layui-form-text">
                                                ...
                                                <div class="layui-input-block">
                                                    <textarea name="word" placeholder="请输入单词" class="layui-textarea" lay-verify="required"></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="layui-form-item layui-form-text">
                                                ...
                                                <div class="layui-input-block">
                                                    <textarea name="grammar" placeholder="请输入语法" class="layui-textarea" lay-verify="required"></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="layui-form-item layui-form-text">
                                                ...
                                                <div class="layui-input-block">
                                                    <textarea name="friend" placeholder="请输入@人物" class="layui-textarea" lay-verify="required"></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="layui-form-item layui-form-text">
                                                ...
                                                <div class="layui-input-block">
                                                    <textarea name="daily_sentence" placeholder="请输入每日一句" class="layui-textarea" lay-verify="required"></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="layui-form-item">
                                                ...
                                                <button type="button" class="layui-btn layui-btn-primary data_reset">数据还原</button>
        ...
        <script src="./res/js/modules/moment.min.js"></script>
