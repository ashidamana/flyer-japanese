                                    ...
                                    <div class="layui-tab-item layui-show">
                                        <form action="" method="post">
                                            ...
                                            <div class="layui-form-item">
                                                ...
                                                <button type="button" class="layui-btn layui-btn-warm">一键复制</button>

                                            </div>

                                            <!--详细操作-->
                                            <div class="layui-form-item">
                                                <button type="button" class="layui-btn layui-btn-sm layui-btn-primary">复制第1条</button>
                                                <button type="button" class="layui-btn layui-btn-sm layui-btn-primary">复制第2条</button>
                                                <button type="button" class="layui-btn layui-btn-sm layui-btn-primary">复制第3条</button>
                                                <button type="button" class="layui-btn layui-btn-sm layui-btn-primary">复制第4条</button>
                                                <button type="button" class="layui-btn layui-btn-sm layui-btn-primary">复制第5条</button>
                                                <button type="button" class="layui-btn layui-btn-sm layui-btn-primary">复制第6条</button>
                                            </div>
