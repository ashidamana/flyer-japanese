                        ...
                        <div class="layui-col-md12">
                            <div class="fly-panel" pad20 style="padding-top: 5px;">
                                <div class="fly-home fly-panel" style="background-image: url();">
                                    <img src="https://ooo.0o0.ooo/2017/06/27/5951e19dce0d3.png" alt="贤心">
                                        ...
                                        <form action="" method="post">
                                            <div class="layui-form-item">
                                                ...
                                                <div class="layui-input-block">
                                                    <input type="text" name="price_min" placeholder="请输入中文名" autocomplete="off" class="layui-input">
                                                </div>
                                            </div>
                                            <div class="layui-form-item">
                                                <label class="layui-form-label" style="text-align: left;">2.日文名</label>
                                                <div class="layui-input-block">
                                                    <input type="text" name="price_min" placeholder="请输入日文名" autocomplete="off" class="layui-input">
                                                </div>
                                            </div>
                                            <div class="layui-form-item">
                                            ...
                                            <div class="layui-form-item">
                                                <div class="layui-inline">
                                                    ...
                                                    <div class="layui-input-inline">
                                                        <input type="text" name="price_min" placeholder="请输入五十音" autocomplete="off" class="layui-input">
                                                    </div>
                                                    <div class="layui-form-mid">-</div>
                                                    <div class="layui-input-inline">
                                                        <div class="layui-input-inline">
                                                            <input type="radio" name="sex" value="行" title="行" checked>
                                                            <input type="radio" name="sex" value="段" title="段">
                                                        </div>                                                    
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="layui-form-item layui-form-text">
                                                ...
                                                <div class="layui-input-block">
                                                    <textarea name="desc" placeholder="请输入单词" class="layui-textarea"></textarea>
                                                </div>
                                            </div>
                                            <div class="layui-form-item layui-form-text">
                                                <label class="layui-form-label">6.语法</label>
                                                <div class="layui-input-block">
                                                    <textarea name="desc" placeholder="请输入语法" class="layui-textarea"></textarea>
                                                </div>
                                            </div>
                                            <div class="layui-form-item">
                                                <label class="layui-form-label" style="text-align: left;">7.表达方式</label>
                                                <div class="layui-input-block">
                                                    <input type="text" name="price_min" placeholder="请输入附加说明" autocomplete="off" class="layui-input">
                                                </div>
                                            </div>
                                            <div class="layui-form-item layui-form-text">
                                                <div class="layui-input-block">
                                                    <textarea name="desc" placeholder="请输入表达方式" class="layui-textarea"></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="layui-form-item layui-form-text">
                                                ...
                                                <div class="layui-input-block">
                                                    <textarea name="desc" placeholder="请输入@人物" class="layui-textarea"></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="layui-form-item layui-form-text">
                                                ...
                                                <div class="layui-input-block">
                                                    <textarea name="desc" placeholder="请输入每日一句" class="layui-textarea"></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="layui-form-item">
                                                ...
                                                <button type="reset" class="layui-btn layui-btn-warm">一键复制</button>

                                            </div>

                                            <div class="layui-form-item">
                                                <button type="reset" class="layui-btn layui-btn-sm layui-btn-primary">复制第1条</button>
                                                <button type="reset" class="layui-btn layui-btn-sm layui-btn-primary">复制第2条</button>
                                                <button type="reset" class="layui-btn layui-btn-sm layui-btn-primary">复制第3条</button>
                                                <button type="reset" class="layui-btn layui-btn-sm layui-btn-primary">复制第4条</button>
                                                <button type="reset" class="layui-btn layui-btn-sm layui-btn-primary">复制第5条</button>
                                                <button type="reset" class="layui-btn layui-btn-sm layui-btn-primary">复制第6条</button>
                                            </div>
